...
public class BatchDataLoaderDemo {
    ...
    private Redis redisIntegration;
    private BatchLoader<String, Object> batchLoader = new BatchLoader<String, Object>() {
        @Override
    ...
    public void changeCachingSolutionOfDataLoader() {
